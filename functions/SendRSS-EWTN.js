...
rssToTelegram({
 ...
 channel: '@palabradecadadia',
  ...
  //source: "https://vaticannews.va/es/podcast/programas-en-espanol.podcast.xml", // can be an async function or and array of objects
  source: "https://www.ewtn.com/api/feed/~GZ.xml", // can be an async function or and array of objects
